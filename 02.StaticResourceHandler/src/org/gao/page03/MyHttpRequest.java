 ...
 * @Description: 增强版 HTTP 请求解析，新增请求头解析及数组越界防护
 * @Version: 1.0
 */
public class MyHttpRequest {
    ...
    /**
     * @Description: 分发解析：先切请求行，再根据 GET/POST 分别处理参数和请求体，最后解析请求头
     */
    ...
    /**
     * @Description: 遍历请求报文数组，按 : 拆分请求头键值对，存入 requestHeadParams
     */
    ...
    /**
     * @Description: 按 & 和 = 拆分请求体参数，存入 requestParams
     */
